 ...
 */
export declare class ChannelSettings extends Message<ChannelSettings> {
  /**
   *
  ...
  constructor(data?: PartialMessage<ChannelSettings>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "meshtastic.ChannelSettings";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ChannelSettings;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ChannelSettings;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ChannelSettings;

  static equals(a: ChannelSettings | PlainMessage<ChannelSettings> | undefined, b: ChannelSettings | PlainMessage<ChannelSettings> | undefined): boolean;
}
...
export declare class Channel extends Message<Channel> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "meshtastic.Channel";
  static readonly fields: FieldList;
 ...
 */
export declare enum Channel_Role {
  /**
   *
